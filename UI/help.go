...
func RenderHelp(m Model) string {
	...
	helpContent := []string{
		...
		keyStyle.Render("1, 2, 3, 4, 5") + descStyle.Render("Jump to section (Projects, Tasks, Notes, Details, Drafts)"),
		"",
		...
		keyStyle.Render("s") + descStyle.Render("Create subtask (child of selected task)"),
